...
set_false_path -from [get_ports {gpio_bot_in[0]}]  ;# uart_rx
set_false_path -from [get_ports {gpio_bot_in[1]}]  ;# spi_csn
set_false_path -from [get_ports {gpio_bot_in[2]}]  ;# spi_sck
set_false_path -from [get_ports {gpio_bot_in[3]}]  ;# spi_mosi